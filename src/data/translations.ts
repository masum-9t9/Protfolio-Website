...
export const UI_TRANSLATIONS = {
  bn: {
    ...
    footer: {
      ...
      brandBio: 'প্রফেশনাল গ্রাফিক্স ডিজাইনার,ডেভেলপারও কন্টেন্ট ক্রিয়েটর। পোস্টার ডিজাইন, হাই-সিটিআর ইউটিউব থাম্বনেল, এডুকেশন ভিজ্যুয়াল এবং কাস্টম থিম ডিজাইনে বিশেষজ্ঞ।',
  ...
  en: {
    ...
    footer: {
      ...
      brandBio: 'Professional Graphics Designer, Developer & Content Creator. Specialized in poster design, high-CTR YouTube thumbnails, educational visuals, and custom theme designs.',
